...
https://github.com/keketso-prog/AWS-RE-START-JOURNEY/blob/main/Project-Gallery.md/Project-1.md
# About This Project
...
- An easy-to-navigate menu that looks great on phones and computers
- A booking system that shows real-time availability (no more double bookings!)
- Online ordering so customers can browse and order at their own pace
- A way to keep track of customer preferences and special requests

We decided to host everything on AWS because, frankly, it made the most sense for what the restaurant needed.
...
# How We Built It
We kept the technical side simple but effective:

- Amazon S3 for hosting the website files
...
# What Changed
A few weeks after launch, we stopped by to check in with the owner. The difference was honestly amazing. They greeted us with a huge smile—completely different from the stressed-out person we'd first met.
The double bookings were gone, orders were coming through clearly, and the owner wasn't glued to their phone anymore. They actually had time to walk around the dining room, chat with customers, and focus on what they love—the food and the experience.
Even the staff seemed relieved. When orders are clear and bookings are organized, everyone's job gets easier.
