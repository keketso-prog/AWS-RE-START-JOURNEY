...
# Working as a team
Working together on the 3D architecture project had its ups and downs. Honestly, we struggled with communication at first—coordinating who was doing what and making design decisions together wasn't always smooth. But when crunch time came, we figured it out. We started checking in more often, clarified our roles, and just pushed through. Despite the rocky start, we managed to get the project finished on time. It wasn't perfect teamwork, but we made it work and learned a lot about staying organized under pressure.
