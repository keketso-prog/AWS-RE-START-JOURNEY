# BASH SHELL SCRIPTING EXERCISE
 ...
 I worked through a hands-on lab creating a Bash script that automatically generates batches of files with incrementing numbers, learning about automation, loops, and dynamic file creation.
...
<img width="444" height="437" alt="Screenshot (1879)" src="https://github.com/user-attachments/assets/a5553069-225f-4350-8230-452ae50850a7" />
...
I ran the script multiple times to verify the automation worked correctly. Each execution created the next batch of 25 files with properly incrementing numbers—files 26-50 
